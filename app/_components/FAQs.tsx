...
const FAQs = () => {
  return (
    ...
    >
      <div className='relative md:w-3/5 border-[1px] mx-auto border-primary-700 bg-white rounded-md p-6  before:absolute before:content-[""] before:bg-white before:rounded-md before:w-full before:h-full before:border-[1px] before:border-primary-700 before:top-2 before:right-2 before:-z-[2] z-[2] '>
